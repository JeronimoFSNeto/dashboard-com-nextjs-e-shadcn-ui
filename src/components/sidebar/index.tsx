  ...
  return (
    <div className="flex w-full flex-col bg-muted/40">
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <Link
                  ...
                  text-muted-foreground transition-colors hover:text-foreground rounded-lg "
                >
      ...
      <div className="sm:hidden flex flex-col sm:gap-4 sm:py-4 sm:pl-14">
        <header
          className="sticky top-0 z-30 flex h-14 items-center px-4 bottom-b bg-background gap-4 sm:static 
          ...
          <Sheet>
            ...
            <SheetContent className="sm:max-w-x">
              <nav className="grid gap-6 text-lg font-medium">
                <Link
                  href="/"
                  className="flex w-10 h-10 bg-primary rounded-full items-center justify-center text-lg text-primary-foreground md:text-base gap-2"
                  prefetch={false}
                >
